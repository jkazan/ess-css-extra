...
echo "===="
(cd maven-osgi-bundles; time mvn -B clean verify) | tee 0_maven-osgi-bundles.log

echo "===="
echo "==== BUILDING cs-studio-thirdparty"
echo "===="
(cd cs-studio-thirdparty; time mvn -B clean verify) | tee 1_cs-studio-thirdparty.log

echo "===="
echo "==== BUILDING diirt"
echo "===="
(cd diirt; time mvn -B clean verify) | tee 2_diirt.log
...
echo "==== BUILDING cs-studio/applications"
echo "===="
(cd org.csstudio.display.builder; time mvn -Dcss-repo=file:/Users/claudiorosati/Projects/GitHub/ess-css-extra/ess_css_comp_repo -Declipse-site=http://download.eclipse.org/releases/mars -B clean verify) | tee 5_org.csstudio.display.builder.log

echo "===="
echo "==== BUILDING org.csstudio.product"
echo "===="
(cd org.csstudio.product; time mvn -B clean verify) | tee 6_org.csstudio.product.log

echo "===="
echo "==== BUILDING org.csstudio.ess.product"
echo "===="
(cd org.csstudio.ess.product; time mvn -B clean verify) | tee 7_org.csstudio.ess.product.log
